import { Fn, min, sub, max, vec3, float, add, If, select, sin, cos, vec4, mul, cross, remap, pow, log2, mat4, smoothstep, positionGeometry, dFdx, dFdy, transformNormalToView, mx_worley_noise_float, mx_noise_float, exp, normalLocal, tangentLocal } from 'three/tsl';
